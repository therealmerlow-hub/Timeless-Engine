...
class Main extends Sprite
{
	...
	private function setupGame():Void
	{
		...
		FlxG.save.bind('TimelessEngine', CoolUtil.getSavePath(), (rawSave, error) ->
		{
			#if sys
			trace("Couldn't load main save.");
			try
			{
				var badSave = File.write(StorageUtil.getStorageDirectory() + "/TimelessEngine.sol.bad");
