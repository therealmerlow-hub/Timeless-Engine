...
class DiscordClient
{
	...
	private inline static final _defaultID:String = "1541934848988414022";
	...
	public static function changePresence(details:String = 'Main Menu', ?state:String, ?smallImageKey:String, ?hasStartTimestamp:Bool, ?endTimestamp:Float, largeImageKey:String = 'icon')
	{
