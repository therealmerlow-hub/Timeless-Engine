...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var defaultList:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			['Timeless Engine Developer'],
			['Timeless',			'timeless',			'Main Programmer, artist and Head of Timeless Engine',								 'https://discord.com/users/1347569284947382272',									'2ebcfa'],
			[""],
			["Timeless server"],
			["Join our community",	"timelessengine",			"",																"https://discord.gg/wwRFyt8Wx",			"5e36c4"],
			[""],
			["Psych Engine Team"],
