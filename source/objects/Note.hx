	...
	**/
	...
	private function set_noteType(value:String):String {
		...
		case 'FakeGlitchNote':
				...
				lowPriority = false;
				hitCausesMiss = false;
				this.texture = 'noteSkins/GlitchNOTE_assets';
				this.noteSplashData.texture = 'noteSplashes/GlitchnoteSplashes';
		...
		case 'Glitch Note':
			ignoreNote = true;
			lowPriority = true;
			this.texture = 'noteSkins/GlitchARROWS_assets';
			this.noteSplashData.texture = 'noteSplashes/GlitchnoteSplashes';	
					...
					noteSplashData.texture = 'noteSplashes/GlitchnoteSplashes';
	...
	override function update(elapsed:Float)
	{
		...
		if (!isSustainNote) {
				var isOffscreen:Bool = (this.y < -200 || this.y > flixel.FlxG.height + 200);
			
				this.visible = !isOffscreen;
		}
	}
