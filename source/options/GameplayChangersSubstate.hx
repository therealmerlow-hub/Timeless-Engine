...
class GameplayChangersSubstate extends MusicBeatSubstate
{
	...
	function getOptions()
	{
		...
		var option:GameplayOption = new GameplayOption('Glitch Notes Amount', 'glitchNotesModifier', PERCENT, 0.1);
		option.scrollSpeed = 1;
		option.minValue = 0.0;
		option.maxValue = 1.0; 
		option.changeValue = 0.05; 
		...
		optionsArray.push(new GameplayOption('Crash on Miss', 'crashOnMiss', BOOL, false));
		optionsArray.push(new GameplayOption('Reverse Health', 'reverseHealth', BOOL, false));
